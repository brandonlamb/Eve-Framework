...
class Memcached implements DriverInterface
{
	...
	{
		return Eve\Cache::driver('memcached')->get($sessionId);
	}
	...
	{
		Eve\Cache::driver('memcached')->put($session['id'], $session, $this->_config['lifetime']);
	}
	...
	{
		Eve\Cache::driver('memcached')->forget($sessionId);
	}
}
