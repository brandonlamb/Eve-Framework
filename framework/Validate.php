...
class Validate
{
	...
	public function isWritable($file)
	{
		...
		$perms = fileperms($resourceAbsolutePath);
	    if (is_writable($resourceAbsolutePath) || ($perms & 0x0080) || ($perms & 0x0010) || ($perms & 0x0002)) {
		    return true;
	    }
	...
	/**
	 * RFC compliant email validation. This function is __LESS__ strict than Validate::email
	 * @param string $email Email address
	 * @return boolean
	 */
	 ...
	 * @return boolean
	 */
	public static function ip($ip, $ipv6 = false, $allowPrivate = true)
	{
	...
	/**
	 * Tests if a string is a valid date using the php [strtotime()](http://php.net/strtotime) function.
	 ...
	 * This function does NOT test if the date is valid, just that the format is valid.
	...
	/**
	 * Checks whether a string consists of alphabetical characters, numbers, underscores, commas, spaces and dashes only.
	 * @param string $str Input string
	 * @param boolean $utf8 Trigger UTF-8 compatibility
	 * @return boolean
	 */
	public static function alphaComma($str, $utf8 = false)
	{
		return ($utf8 === true) ? (bool) preg_match('/^[-\pL\pN_, .]++$/uD', (string) $str) : (bool) preg_match('/^[-a-z0-9_, .]++$/iD', (string) $str);
	}
	 ...
	 * @return boolean
	 */
	public static function alphaSpace($str, $utf8 = false)
	{
	 ...
	 * @return boolean
	 */
	public static function alphanumSpace($str, $utf8 = false)
	{
	...
	/**
	 * @param int $postcode zip/postal code
