...
class PasswordHash
{
	 ...
	 * Constructor
	 *
	 * @param int $iterationCountLog2
	 * @param bool $portableHashes whether to use portable hashes
	 */
	...
	protected function _generateSalt($input)
	{
		$output = '$P$';
	...
	protected function _crypt($password, $setting)
	{
		...
		// performance and consequently in lower iteration counts and hashes that are quicker to crack
		// (by non-PHP code).
		if (PHP_VERSION >= '5') {
	...
	protected function _generateSaltExtended($input)
	{
	...
	protected function _generateSaltBlowfish($input)
	{
